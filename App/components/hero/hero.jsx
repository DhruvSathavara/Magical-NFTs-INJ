          ...
          <div className="col-span-6 flex h-full flex-col items-center justify-center py-10 md:items-start md:py-20 xl:col-span-4">
            ...
            <div className="flex space-x-4">
              ...
              {/* <Link href="/collection/explore_collection"> */}
                <a onClick={scrollToPosition} className="text-accent shadow-white-volume hover:bg-accent-dark hover:shadow-accent-volume w-36 rounded-full bg-white py-3 px-8 text-center font-semibold transition-all hover:text-white">
                  Explore
                </a>
              {/* </Link> */}
            </div>
